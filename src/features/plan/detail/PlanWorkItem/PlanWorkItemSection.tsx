...
interface IEmployee {
  ...
  interface ITempPlanTask {
	taskId: number;
	taskName: string;
	// Các thuộc tính khác của task
  }
...
const sampleEmployee: IEmployee = {
	id: 1,
	name: "John Doe",
	// Các thông tin khác của nhân viên
  };
  
  // Dữ liệu mẫu cho các tasks
  const sampleTask1: ITempPlanTask = {
	taskId: 1,
	taskName: "Task 1",
	// Các thông tin khác của task
  };
  
  const sampleTask2: ITempPlanTask = {
	taskId: 2,
	taskName: "Task 2",
	// Các thông tin khác của task
  };
  
  // Dữ liệu mẫu cho các work items
export const sampleWorkItems = [
	{
		isSelected: false,
		orderIndex: 1,
		supervisor: sampleEmployee,
		workItemId: 1,
		workItemCode: "WI001",
		workItemName: "Work Item 1",
	...
	},
	{
		...
		workItemId: 2,
		workItemCode: "WI002",
		workItemName: "Work Item 2",
		tasks: [sampleTask1]
	},
	// Thêm các work items khác vào đây
  ];
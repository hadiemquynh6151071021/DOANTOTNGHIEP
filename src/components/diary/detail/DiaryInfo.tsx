  ...
  const progressChart = useMemo(() => {
    var data = [
      { label: "Khối lượng hoàn thành", value: diary.amountofworkdone, color: "#FFBB28" },
      {
        ...
        value: diary.cmsProgresses ? diary.cmsProgresses.totalamountofworkdone - diary.amountofworkdone : 0 ,
        color: "#00C49F",
      },
      {
        ...
        value:
          ...
          (diary.cmsProgresses ? diary.cmsProgresses.totalamountofworkdone - diary.amountofworkdone : 0) -
